...
## API
В системе присутствует несколько видов API:
- `REST API` - API для связи пользователей с системой управления для работы в ней  [Документация](doc/API.md)
- `Websocket` - API для связи роботов с системой управления по websocket протоколу [Документация](doc/websocketAPI.md)



[Unit-тесты](doc/Tests.md)
