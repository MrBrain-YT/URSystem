...
- В данный момент тесты и основной сервер работают с разными базами аккаунтов но `одной конфигурацией оборудования`, поэтому их не рекомендуеться запускать при работе сервера на производстве